...
<table class="head container" style="font-family: 'Cairo', sans-serif;">
	<tr style="font-family: 'Cairo', sans-serif;">
		<td class="header" style="font-family: 'Cairo', sans-serif;">
		<?php
...
<h1 class="document-type-label" style="font-family: 'Cairo', sans-serif;">
<?php if( $this->has_header_logo() ) echo $this->get_title(); ?>
</h1>

<?php do_action( 'wpo_wcpdf_after_document_label', $this->type, $this->order ); ?>

<table class="order-data-addresses" style="font-family: 'Cairo', sans-serif;">
	<tr>
...
<table class="order-details">
	<thead>
		<tr>
			...
			<th class="item-meta"><?php _e('الحجم', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
	...
	<tbody>
		...
		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
			...
			<td class="item-meta"><?php echo $item['meta']; ?></td>
			...
			<td class="no-borders" style="width:60%">
				...
				<div class="customer-notes">
					<?php if ( $this->get_shipping_notes() && $this->settings['display_customer_notes'] ) : ?>
						<h3 style="font-family: 'Cairo', sans-serif;"><?php _e( 'Customer Notes', 'woocommerce-pdf-invoices-packing-slips' ); ?></h3>
